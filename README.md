...
Нужно собрать css файл с определенными комментариями и зашитыми в base64 шрифтами и тогда они автоматом появятся в Верстке.
...
###Далее, для каждого font-face нужно прописать комментарии
```
  /* font_name: 'Formular'; */
  /* font_style_name: 'Light'; */
```

Чтобы подключить собственные шрифты, необходимо привести файл css к следующему формату:
